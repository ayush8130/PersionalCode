...
public class ServiceUnavailableException extends RuntimeException {
     ...
     * cause.
     * <p>
     * Note that the detail message associated with {@code cause} is <i>not</i> automatically incorporated in this service unavailable exception's detail
     * message.
     *
    ...
    /**
     * Constructs a new service unavailable exception with the specified cause and a
     ...
     * constructor is useful for service unavailable exceptions
    ...
    /**
     * Constructs a new service unavailable exception with the specified detail
